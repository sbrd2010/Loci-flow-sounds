# Loci Flow Sound Variations - Credits

This repository hosts ambient audio variation loops for Loci Flow, served publicly via the jsDelivr CDN.

## Category Sources & Licenses

### 1. Relaxing Rain
- **Source**: Sourced from [Pixabay](https://pixabay.com) and [Mixkit](https://mixkit.co) (Rain Sound Effects).
- **License**: Free for use under the Pixabay License and Mixkit Sound Effects Free License.
- **Tracks**:
  - `calming-rain.mp3`
  - `gentle-rain.mp3`
  - `light-rain-loop.mp3`
  - `rain-in-the-jungle-and-birds.mp3`

### 2. Nature Sounds
- **Source**: Sourced from [Pixabay](https://pixabay.com) (Forest and River Atmospheres).
- **License**: Free for use under the Pixabay License.
- **Tracks**:
  - `river-atmosphere.mp3`
...
- **Tracks & Accreditation**:
  ...
  - **Reflections** by Oraeth | https://soundcloud.com/oraeth
    Licensed under CC BY 3.0 (https://creativecommons.org/licenses/by/3.0/)
  - **Still Falling** by Oraeth | https://soundcloud.com/oraeth
    Licensed under CC BY 3.0 (https://creativecommons.org/licenses/by/3.0/)
  - **Rain and Tears** by Neutrin05 | https://soundcloud.com/neutrin05
    Licensed under CC BY 3.0 (https://creativecommons.org/licenses/by/3.0/)
  - **Aura** by Sappheiros | https://soundcloud.com/sappheirosmusic
    Licensed under CC BY 3.0 (https://creativecommons.org/licenses/by/3.0/)
  - **Dawn** by Sappheiros | https://soundcloud.com/sappheirosmusic
    Licensed under CC BY 3.0 (https://creativecommons.org/licenses/by/3.0/)
  - **Escape** by Sappheiros | https://soundcloud.com/sappheirosmusic
    Licensed under CC BY 3.0 (https://creativecommons.org/licenses/by/3.0/)
  - **Falling (feat. eSoreni)** by Sappheiros | https://soundcloud.com/sappheirosmusic
    Licensed under CC BY 3.0 (https://creativecommons.org/licenses/by/3.0/)
  - **Memories** by Sappheiros | https://soundcloud.com/sappheirosmusic
    Licensed under CC BY 3.0 (https://creativecommons.org/licenses/by/3.0/)
  - **Passion** by Sappheiros | https://soundcloud.com/sappheirosmusic
    Licensed under CC BY 3.0 (https://creativecommons.org/licenses/by/3.0/)
  - **Descent** by Sappheiros | https://soundcloud.com/sappheirosmusic
    Licensed under CC BY 3.0 (https://creativecommons.org/licenses/by/3.0/)
...
## Existing Open Lo-Fi Collection (Intact)
The following categories are sourced from the **Open Lo-Fi** public-domain collection:
- **Source Repository**: [btahir/open-lofi](https://github.com/btahir/open-lofi)
- **License**: CC0 1.0 Universal (Public Domain)

### Jazz (Jazz Lounge)
- `sounds/jazz/rain-on-the-boulevard.mp3` - "Rain on the Boulevard"
- `sounds/jazz/breezy-afternoon-terrace.mp3` - "Breezy Afternoon Terrace"
- `sounds/jazz/saxophone-in-the-rain.mp3` - "Saxophone in the Rain"
- `sounds/jazz/candlelit-at-70-bpm.mp3` - "Candlelit at 70 BPM"
- `sounds/jazz/linen-and-limoncello.mp3` - "Linen and Limoncello"
- `sounds/jazz/ashes-in-the-coffee-cup.mp3` - "Ashes in the Coffee Cup"
- `sounds/jazz/last-call-in-c-minor.mp3` - "Last Call in C Minor"

### Piano (Cozy Piano)
- `sounds/piano/dusk-between-stoops.mp3` - "Dusk Between Stoops"
- `sounds/piano/porchlight-golden-hour.mp3` - "Porchlight Golden Hour"
- `sounds/piano/soft-gold-sky.mp3` - "Soft Gold Sky"
- `sounds/piano/window-seat-daydream.mp3` - "Window Seat Daydream"
- `sounds/piano/glow-on-the-overpass.mp3` - "Glow on the Overpass"
- `sounds/piano/sidewalk-slow-jam.mp3` - "Sidewalk Slow Jam"
- `sounds/piano/sunset-offbeat.mp3` - "Sunset Offbeat"

### Lofi (Lo-Fi Beats)
- `sounds/lofi/first-coffee-thoughts.mp3` - "First Coffee Thoughts"
- `sounds/lofi/penciled-sunbeams.mp3` - "Penciled Sunbeams"
- `sounds/lofi/terminal-rain.mp3` - "Terminal Rain"
- `sounds/lofi/coffee-ring-notebook.mp3` - "Coffee Ring Notebook"
- `sounds/lofi/graphite-mornings.mp3` - "Graphite Mornings"
- `sounds/lofi/margin-notes-at-dusk.mp3` - "Margin Notes at Dusk"
- `sounds/lofi/morning-pages.mp3` - "Morning Pages"
